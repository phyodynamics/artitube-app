  ...
  return (
    <div className="group/avatar flex flex-col items-center justify-center gap-2">
      <div className="justy-start flex -space-x-4 select-none" {...props}>
        ...
        {extraCount && (
          <div key="extra-count-badge" className="z-20 flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-4 border-white bg-neutral-100 shadow-sm dark:border-neutral-900 dark:bg-neutral-950">
